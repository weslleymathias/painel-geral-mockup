      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card style={{ borderTop: '4px solid #FFCEB5' }}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <HeartPulse className="h-4 w-4" style={{ color: '#FFCEB5' }} />
          </CardHeader>
          <CardContent>
            <div style={{ color: '#Ff8359' }}>195/200</div>
            <Progress value={97.5} className="mt-2" style={{ backgroundColor: '#FFF4EE' }} />
          </CardContent>
        </Card>
        ...
        <Card style={{ borderTop: '4px solid #FFCEB5' }}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Activity className="h-4 w-4" style={{ color: '#FFCEB5' }} />
          </CardHeader>
          <CardContent>
            <div style={{ color: '#Ff8359' }}>188</div>
        ...
        <Card style={{ borderTop: '4px solid #Ff8359' }}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Thermometer className="h-4 w-4" style={{ color: '#Ff8359' }} />
          </CardHeader>
          <CardContent>
            <div style={{ color: '#990000' }}>5</div>
            <p className="text-xs text-gray-500 mt-1">
        ...
        <Card style={{ borderTop: '4px solid #990000' }}>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm">Alertas Ativos</CardTitle>
            <AlertCircle className="h-4 w-4" style={{ color: '#990000' }} />
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                ...
                <div key={alerta.id} className="flex items-center justify-between p-4 rounded-lg" style={{ backgroundColor: '#FFF4EE' }}>
                  <div>
          ...
          <CardContent>
            <div className="space-y-6">
              <div>
                ...
                <Progress value={85} className="h-2" style={{ backgroundColor: '#FFF4EE' }} />
              ...
              <div>
                ...
                <Progress value={75} className="h-2" style={{ backgroundColor: '#FFF4EE' }} />
              ...
              <div>
                ...
                <Progress value={78} className="h-2" style={{ backgroundColor: '#FFF4EE' }} />
              ...
              <div>
                ...
                <Progress value={92} className="h-2" style={{ backgroundColor: '#FFF4EE' }} />
